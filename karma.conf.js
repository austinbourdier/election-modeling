...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      // moment
      { pattern: 'node_modules/moment/**/*.js', included: false, watched: true },

      // NG2 pagination
      { pattern: 'node_modules/ng2-pagination/**/*.js', included: false, watched: true },

      // ng2-bootstrap
      { pattern: 'node_modules/ng2-bootstrap/**/*.js', included: false, watched: true },
